# AminoSwitch
You can find the datapoints and information for classified switch residues through β2AR receptor 🔗 [here]([LINK](https://drive.google.com/file/d/13Hmu9U-cHUlgrlKw9ow4ONeIZJtMuWgJ/view?usp=sharing
))
...
The Instability_ratio.py measures the Instability ratio for a given dataset.
The training dataset for classifying SS and US residues is training_dataset_SS_US_residue.csv
